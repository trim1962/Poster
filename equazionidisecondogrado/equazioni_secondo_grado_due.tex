...
radius=5pt,
		...
		\node[decision,below left=1cm and 2.1cm of 4] (6) {$\Delta=0$};
		...
		\node[connessione,below of=4,node distance=3.2cm] (12) at (9 -| 4){};
		\node [cloud,below of=12,node distance=1cm] (stop) {Fine};
			\path [line] (init) -- (1);
     		\path [line] (1) --  (2);
     		\path [line] (2) --  (3);
     		\path [line] (3) --  (4);
    		...
    		\path [line] (8) --  (10);
     		...
     		\path [line] (11.south) -- ++(0,-1)|- (12);
    		\path [line] (5.south) -- ++(0,-1)|- (12);
    		\path [line] (12) --  (stop);
		\end{tikzpicture}
\end{document}
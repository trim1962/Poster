...
%	\begin{center}
		...
		\node[decision,below of=1] (2) {$a=0$};
			\node[decision,below right=0.0cm and 2cm of 2] (3) {$b=0$};
			\node[decision,below right=0.0cm and 2cm of 3] (4) {$c=0$};
...
%	\node [cloud, below of=nodo5] (stop) {Fine};
			...
			\path [line] (passo1) -- (1);
     		\path [line] (1) --  (2);
     		\path [line] (2.east) -- node[near start] {Si} (3.north);
     		\path [line] (3.east) -- node[near start] {Si} (4.north);

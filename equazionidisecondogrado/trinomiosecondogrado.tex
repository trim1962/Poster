...
radius=5pt,
		...
		\begin{tikzpicture}[scale=1, %node distance = 2.5cm,
			...
			del termine di 
			secondo grado, $b$ è il numero del termine di primo grado, $c$ è il 
		...
		\node[decision,below of=1,node distance=2.5cm] (2) {$a=0$};
			...
			\node[decision,below right=1.0cm and 2.1cm of 3] (4) {$c=0$};
			\node[print,below left=0.5cm and 1.7cm of 3,text width=5em, ] (8) 
			{Soluzione 
			$x=-\dfrac{c}{b}$};
		\node[print,below left=0.5cm and 1.7cm of 4,text width=5em, ] (6) 
		...
		\node[print,below right=0.5cm and 1.6cm of 12,text width=5em, ] (13) 
		{Non ho soluzioni reali};
		\node[decision,below left=1cm and 2.0cm of 12] (14) {$\Delta=0$};
		\node[print,below right=0.5cm and 1.6cm of 14,text width=5em, ] (15) 
		{Ho soluzioni coincidenti};
		\node[print,below left=0.5cm and 1.6cm of 14,text width=5em, ] (17) 
		{Ho soluzioni distinte};
		...
		\node[connessione,below of=12,node distance=3.2cm] (20) at (16 -| 12){};

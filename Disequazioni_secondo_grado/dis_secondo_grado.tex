...
%	\begin{center}
	...
	{$a>0$};
	\node [block, right of=passo2Si, node distance=3.8cm] (passo2SiSi) 
...
{\begin{tikzpicture}[line cap=round,line join=round,>=triangle 
		...
		\draw (0.3,0.02) node[anchor=north west] {$x_2$};
\end{tikzpicture}};
\node [decision, below of=passo2, node distance=5cm] (passo2No) 
{$\Delta=0$};
node [decision, right of=passo2No, node distance=3.5cm] (passo2NoSi) 
{$a>0$};

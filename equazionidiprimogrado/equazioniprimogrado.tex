...
%	\begin{center}
		...
		\begin{tikzpicture}[scale=1, %node distance = 2.5cm,
			...
			\node [input, below of=passo1] (passo2) {Leggo l'espressione da sinistra verso destra cercando le incognite};
			...
			\node [decision, below of=nodo1] (decisione2) {Arrivato a destra?};
%			\node [print, below of=decisione2,node distance=3cm] (sceltasi2) {La trascrivo uguale a sinistra (prima) dell'uguale};
			\node [print, right of=decisione2,node distance=6cm] (sceltano2) {La trascrivo cambiata di segno a sinistra  prima dell'uguale};

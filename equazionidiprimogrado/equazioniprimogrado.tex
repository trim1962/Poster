...
%	\begin{center}
		...
		\begin{tikzpicture}[scale=1, %node distance = 2.5cm,
			...
			\node [block, below of=decisione1,node distance=3cm] (passo4) {Semplifico la frazione};
			\node [block, right of=decisione1,node distance=3cm] (passo5) {Semplifico le frazioni in croce};

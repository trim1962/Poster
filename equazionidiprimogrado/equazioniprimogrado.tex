...
%	\begin{center}
		...
		\node [input, below of=node3,node distance=3cm] (sceltasi2) {Leggo l'espressione da sinistra verso destra cercando i numeri};
		\node [decision, below of=node3,node distance=3cm] (decisione3) {Il numero è a sinistra (prima) dell'uguale?};

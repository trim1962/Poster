...
%	\begin{center}
	...
	\node [print, below of=decisione3,node distance=3cm] (sceltasi3) {La trascrivo uguale a sinistra (prima) dell'uguale};
\node [print, right of=decisione3,node distance=6cm] (sceltano3) {La trascrivo cambiata di segno a sinistra  prima dell'uguale};

...
\begin{center}
	\smartdiagramset{set color list={white,white,white,white,white,white,white},
	}
	\smartdiagram[descriptive diagram]{
		...
		{5, {Sottraggo al numero formato dalle cifre della parte intera edall'antiperiodo e scrivo il risultato al numeratore}},{6,{Scrivo a denominatore tanti nove quante sono le cifre del periodo e tanti zero per quante sono le cifre dell'antiperiodo }},{7,{Fine}},
	}
\end{center}
\end{document}
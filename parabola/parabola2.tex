...
{\begin{center}
		...
		\end{tikzpicture}
\end{center}}
\posterbox[fit,adjusted title=Vertice,halign=left,halign=flush left,  valign=top]{name=vertice,column=1,row=3,span=1}
{\[\begin{cases}
		x=&-\dfrac{b}{2a}\\
		y=&-\dfrac{\Delta}{4a}\\
		\Delta=&b^2-4ac
...
%\end{tikzpicture}
%\end{center}}
\posterbox[fit,adjusted title=Fuoco,halign=left,halign=flush left,  valign=top]{name=Fuoco,column=2,row=3}
{\[\begin{cases}
		x=&-\dfrac{b}{2a}\\
		y=&\dfrac{1-\Delta}{4a}\\
	\end{cases}\]
}
\posterbox[fit,adjusted title=Asse parabola,halign=left,halign=flush left,  valign=top]{name=AsseParabola,column=1,row=4}
{\[x=-\dfrac{b}{2a}\]
}
\posterbox[fit,adjusted title=Direttrice,halign=left,halign=flush left,  valign=top]{name=direttrice,column=3,row=3}
{\[y=-\dfrac{1+\Delta}{4a}\]
}
...
%{Nessuna soluzione}
%\posterbox[fit,adjusted title=Soluzioni distinte,halign=left,halign=flush left,  valign=top]{name=soldis,column=1,row=5,span=1}
%{\begin{center}
%		\begin{tikzpicture}[line cap=round,line join=round,x=0.75cm,y=0.75cm]
%			\clip(-3.,-2.5) rectangle (3.,2.5);
%			\draw[color=black,smooth,samples=100,domain=-3.0:3.0] plot(\x,{1/2*(\x)^(2)-2});
...
%		\end{tikzpicture}
%\end{center}}
%\posterbox[fit,adjusted title=Soluzioni coincidenti,halign=left,halign=flush left,  valign=top]{name=solcon,column=2,row=5,span=1}
%{\begin{center}
...
%		\end{tikzpicture}
%\end{center}}
%\posterbox[fit,adjusted title=Nessuna Soluzione,halign=left,halign=flush left,  valign=top]{name=nosol,column=3,row=4,span=1}
%{\begin{center}
%		\begin{tikzpicture}[line cap=round,line join=round,x=0.75cm,y=0.75cm]
%			\clip(-3.,-2.5) rectangle (3.,2.5);
%			\draw[color=black,smooth,samples=100,domain=-3.0:3.0] plot(\x,{1/2*(\x)^(2)-2});

...
\node[block, right of=decisione4, node distance=3.5cm,text width=3em,] (dec4No) {$c=0$};
\node[block, below of=decisione4, node distance=2.0cm] (dec4Si) {$c$ è il termine noto};
\node[connessione,below of=dec4Si,node distance=2cm] (nodo3) {};

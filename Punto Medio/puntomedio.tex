...
%	\begin{center}
	...
	\node [input, below of=passo1, node distance=1cm] (passo2) {Leggo le coordinate del punto $B(x_2,y_2)$};		
		\node [block, below of=passo2] (passo3) {Sommo $x_1+x_2$};
		\node [block, below of=passo3] (passo4) {Sommo $y_1+y_2$};		

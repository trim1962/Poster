...
%	\begin{center}
		\begin{tikzpicture}[scale=1, node distance = 2.5cm, auto]
			...
			\node [loop, below of=passo4] (passo5) {Per ogni frazione. };
			\node [block, below of=passo5] (passo5a) {Divido il $mcm$ per il denominatore e moltiplico il risultato per il numeratore. Scrivo con segno i risultati};
			\node [decision, below of=passo5a,node distance=4cm] (passo5b) {Le frazioni sono finite?};
			\node [block, below of=passo5b] (passo6) {Sommo i risultati};
			...
			\path [line] (passo5) -- (passo5a);
			\path [line] (passo5a) -- (passo5b);
			\path [line] (passo5b) -- node [near start] {Si} (passo6);
			\path [line] (passo6) -- (nodo1);
			\path [line] (nodo1) -- (fine);
			\path [line] (scelta1)  |-(nodo1);
			\path [line] (passo5b.east) -| ++(1,0)-- node [near start] {No} ++(1,0)|-(passo5);
%%			\path [line] (passo4) -- (passo5);
%%			\path [line] (passo5) -- (passo6);
%		%	\path [line] (passo4) -- (fine);
